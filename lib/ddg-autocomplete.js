...
exports.loadIntoWindow = function loadIntoWindow(window) {
  if (!window) return;
...
exports.unloadFromWindow = function unloadFromWindow(window) {
  if (!window) return;
    ...
    if (this._listener) {
      ...
      var FormatResult = function(aType) {
        return function(aResult) {
          // Ignore null results
          if (aResult.CustomLabel != undefined || aResult.FirstURL != undefined) {
