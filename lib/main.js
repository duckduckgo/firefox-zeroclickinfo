...
var engineURL = 'https://duckduckgo.com/opensearch.xml?atb=v' + Math.ceil((new Date().getTime() - 1456333200000) / 604800000);
...
function onPrefChange(prefName) {
    if (prefName == 'zeroclick') {
        ...
        if (prefSet.prefs['ddg_default'] === true) {
            ...
            if (ddg == null) {
                SearchSettings.addSearchEngine(engineURL, true);
            } else {
...
exports.main = function(options, callbacks) {
    ...
    if (ddg == null && (options.loadReason != 'install' && options.loadReason != 'enable'))
      SearchSettings.addSearchEngine(engineURL);
