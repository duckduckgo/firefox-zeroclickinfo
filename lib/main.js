...
var DDGAutocomplete = require("ddg-autocomplete").DDGAutocomplete;
...
var windowListener = {
  onOpenWindow: function(aWindow) {
    ...
    domWindow.addEventListener("load", function() {
      ...
      DDGAutocomplete.loadIntoWindow(domWindow);
    }, false);
  },
...
function startup(aData, aReason) {
  ...
  while (enumerator.hasMoreElements()) {
    ...
    DDGAutocomplete.loadIntoWindow(win);
  }
...
function shutdown(aData, aReason) {
  ...
  while (enumerator.hasMoreElements()) {
    let win = enumerator.getNext();
    DDGAutocomplete.unloadFromWindow(win);
  }
