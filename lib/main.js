...
function onPrefChange(prefName) {
    if (prefName == 'zeroclick') {
        ...
        if (prefSet.prefs['ddg_default'] == true) {
            ...
            contentPrefService.set("browser.search.defaultenginename", DDG_URL);
        } else {
...
exports.main = function(options, callbacks) {
    ...
    if ( (options.loadReason != 'startup' && options.loadReason !== undefined) ||
        ...
        if (browserSearchService.getEngineByName('DuckDuckGo') === null) {
            browserSearchService.addEngine(data.url('search.xml'), 
                    Ci.nsISearchEngine.DATA_XML, data.url('img/icon_16.png'), true);
            // it's 1 (because of magic and you need to read the Firefox code
            // to understand it)
...
exports.onUnload = function (reason) {
    if (reason === 'disable') {
        contentPrefService.set("browser.search.defaultenginename", ""); // reseting the location bar search
    }
