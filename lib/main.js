...
var VersionManager = require('versionmanager').VersionManager;
...
exports.main = function(options, callbacks) {
    ...
    VersionManager.addIgnoredVersions(['0.3.11']);
    ...
    if (options.loadReason == "install" || options.loadReason == "upgrade") {
        ...
        if (self.version != ss.storage.last_version) {
            ...
            if (prefSet.prefs['thankspage'] && !VersionManager.isIgnored(self.version) ) {
                var tabs = require('sdk/tabs');
