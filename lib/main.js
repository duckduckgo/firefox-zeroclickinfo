...
function prepareToobarButton() {
    ...
    var osString = Cc["@mozilla.org/xre/app-info;1"]
                    .getService(Ci.nsIXULRuntime).OS;
    var img = self.data.url('img/icon_24.png');
    if (osString == "Darwin") {
        img = self.data.url('img/icon_16.png');
    }
...
function startup(aData, aReason) {
  ...
  console.log(DDGAutocomplete);
  DDGAutocomplete.registerComponent(DDGAutocomplete.DDGAutocomplete);
}
...
function shutdown(aData, aReason) {
  ...
  DDGAutocomplete.unregisterComponent(DDGAutocomplete.DDGAutocomplete);
}
